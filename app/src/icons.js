...
export const Trash = ({ s = 18, c = C.ink70 }) => (
  <Svg width={s} height={s} viewBox="0 0 24 24" fill="none">
    <Path
      d="M4 7 H20"
    ...
    />
    <Path
      d="M9.5 7 V5.5 a1.2 1.2 0 0 1 1.2 -1.2 h2.6 a1.2 1.2 0 0 1 1.2 1.2 V7"
      stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round"
    />
    <Path
      d="M6.4 7 l1 12.6 a2 2 0 0 0 2 1.9 h5.2 a2 2 0 0 0 2 -1.9 l1 -12.6"
      stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round"
    />
    <Path
      d="M10.4 11 V17.6 M13.6 11 V17.6"
      stroke={c} strokeWidth={1.6} strokeLinecap="round"
    />
  </Svg>
);

export const Flame = ({ s = 18, c = C.terracotta }) => (
  <Svg width={s} height={s} viewBox="0 0 24 24" fill="none">
...
export const Restart = ({ s = 18, c = C.ink }) => (
  <Svg width={s} height={s} viewBox="0 0 24 24" fill="none">
    <Path
      d="M21 12 a9 9 0 1 1 -3 -7"
      stroke={c} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round"
    />
    <Path
      d="M21 4 V11 H14"
...
export const Bell = ({ s = 14, c = C.ink }) => (
  <Svg width={s} height={s} viewBox="0 0 24 24" fill="none">
    <Path
      d="M6 16 V11 a6 6 0 0 1 12 0 V16 l1.5 2 H4.5 Z"
...
export const Play = ({ s = 14, c = C.terracotta }) => (
  <Svg width={s} height={s} viewBox="0 0 24 24" fill={c}>
    <Path d="M7 5 L7 19 L19 12 Z" stroke={c} strokeWidth={1.2} strokeLinejoin="round" />
  </Svg>
);

export const Swap = ({ s = 14, c = C.terracotta }) => (
  <Svg width={s} height={s} viewBox="0 0 24 24" fill="none">
    <Path
